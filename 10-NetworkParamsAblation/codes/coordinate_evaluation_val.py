...
import torch
from search_configs import MODEL_NAME, params
...
if __name__ == "__main__":
    ...
    EVALUATION_MODEL = glob(f"./log/{MODEL_NAME}/**/best*.ckpt", recursive=True)[0]
    ...
    kpt_model = model.MyLightningModule(params, num_joints=18)
