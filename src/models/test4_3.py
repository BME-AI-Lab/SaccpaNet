...
class MyLightningModule(ClassificationModule):
    def __init__(self):
        super().__init__()
        self.conv = nn.Conv2d(in_channels=19+64,out_channels=3,kernel_size=1,padding=1).cuda()
        self.net = Network(1,18+64)
