...
from lib.modules.hourglass import HourglassNet
...
class MyLightningModule(ClassificationModule):
    def __init__(self):
        ...
        self.init_conv = nn.Conv2d(in_channels=1,out_channels=3,kernel_size=1,padding=0).cuda()
        self.fix_padding_conv =nn.Conv2d(in_channels=18,out_channels=18,kernel_size=3,padding="valid").cuda()
        self.net = HourglassNet(nstack=8,inp_dim=3,oup_dim=18)
