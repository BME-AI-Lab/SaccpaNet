...
from configs.dataset_config import FLIPCUT_AUGMENTED_DB_CONNECTION_STRING


class SQLJointsDataset(JointsDataset):
    DB_CONNECTION_STRING = FLIPCUT_AUGMENTED_DB_CONNECTION_STRING
    ...
    def __init__(
        ...
        self.flip_quilt_only = flipcut_only
        self.num_joints = 18
    ...
    def _initDB(self, subset, indexs):
        ...
        flip_quilt_selector = (
            " AND effect LIKE '%Covered%' " if self.flip_quilt_only else ""
        )
