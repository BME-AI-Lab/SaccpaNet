...
def regnet_sampler():
    ...
    w0 = rand.log_uniform(*W0, 8,)
    wa = rand.log_uniform(*WA, 0.1,)
    wm = rand.log_uniform(*WM, 0.001,)
    gw = rand.power2_or_log_uniform(*GROUP_W, 8,)
    bm = rand.power2_uniform(*BOT_MUL, 1 / 128,)
...
def check_regnet_constraints(param):
    ...
    wa, w0, wm, d = param["REGNET.WA"],param["REGNET.W0"],param["REGNET.WM"],param["REGNET.DEPTH"]#.values()#cfg.REGNET.WA, cfg.REGNET.W0, cfg.REGNET.WM, cfg.REGNET.DEPTH
...
def generate_regnet_full(params):
    ...
    w_a, w_0, w_m, d = params["REGNET.WA"], params["REGNET.W0"], params["REGNET.WM"], params["REGNET.DEPTH"]
